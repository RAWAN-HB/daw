...
export function EvaluationForm({ proposal, onSubmit, onBack }) {
    ...
    <div style={styles.page}>
      ...
      <form onSubmit={handleSubmit} style={styles.card}>
        ...
        <div style={styles.field}>
         ...
         <input type="text" value={evaluatorName} onChange={(e) => setEvaluatorName(e.target.value)} required disabled={isReadOnly}
        ...
        <div style={{ marginBottom: 20 }}> 
          <label style={{ fontWeight: "bold" }}>Commentaires</label>
           <textarea rows={4} value={comments} onChange={(e) => setComments(e.target.value)} required disabled={isReadOnly} 
        style={{ width: "100%", padding: 10, marginTop: 6, borderRadius: 6, border: "1px solid #ccc" }} /> 
        </div>
        {/* Buttons */}
